...
import {ComCommon, LocalBind} from "~/Bridge/ComCommon"
import {AppCore, EventData, getTheApp} from "~/Bridge/AppCore"

export default class ComponentBase extends StackLayout {
    private _isInit: boolean
    protected container: StackLayout
     ...
     * @param viewProperty
     */
    public addBinding(view:View, bindLocalName, viewProperty) {
     ...
     *
     */
    protected setActionResponder(view:View, eventName:string, tag:string = 'action') {
